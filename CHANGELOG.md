...
### Added
- Added a Muse integration with lifecycle hooks for authoritative idle, working, and blocked state plus native session restore via `muse resume`. Install it with `herdr integration install muse`.

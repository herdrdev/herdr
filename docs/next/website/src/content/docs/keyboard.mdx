...
| Close pane | `prefix+x` |
| Swap panes | `prefix+shift+h/j/l`, `prefix+ctrl+k` |
| Resize mode | `prefix+r` |
| Copy mode | `prefix+[` |
| Pluck visible token | `prefix+s` |
| Open Sesh workspace picker | `prefix+shift+k` |

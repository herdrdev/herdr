...
New registry packages can add agent IDs, launch definitions, process recognition, and detection rules without rebuilding Herdr. Trusted reporters and integration installers remain compiled capabilities; a snapshot containing incompatible built-in integration assets is rejected as a whole.

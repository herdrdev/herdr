...
fn api_method_name(method: &Method) -> &'static str {
    match method {
        ...
        Method::WorkspaceGroupList(_) => "workspace_group.list",
        Method::WorkspaceGroupSet(_) => "workspace_group.set",
        Method::WorkspaceGroupRename(_) => "workspace_group.rename",
        Method::WorkspaceGroupDelete(_) => "workspace_group.delete",

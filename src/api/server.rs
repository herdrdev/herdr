...
fn api_method_name(method: &Method) -> &'static str {
    match method {
        ...
        Method::TaskList(_) => "task.list",
        Method::TaskGet(_) => "task.get",
        Method::TaskCreate(_) => "task.create",
        Method::TaskUpdate(_) => "task.update",
        Method::TaskAttach(_) => "task.attach",
        Method::TaskDispatch(_) => "task.dispatch",
        Method::TaskReport(_) => "task.report",

...
pub(crate) use self::{
    ...
    sidebar::{
        ...
        effective_workspace_group_key, expanded_sidebar_sections, expanded_sidebar_toggle_rect,
...
pub fn render_with_runtime_registry(
    ...
    match app.mode {
        ...
        | Mode::RenameWorkspaceGroup => render_rename_overlay(app, frame, frame.area()),

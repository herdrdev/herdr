...
pub(crate) use self::{
    ...
    modal::{
        ...
        handle_task_activity_key, handle_task_board_key, handle_task_panel_key,
    ...
    pub(super) async fn handle_key(
        ...
        match self.state.mode {
            ...
            _ => match self.state.mode {
                ...
                Mode::TaskBoard => handle_task_board_key(&mut self.state, key_event),
                Mode::TaskPanel => handle_task_panel_key(&mut self.state, key_event),
                Mode::TaskActivity => handle_task_activity_key(&mut self.state, key_event),

...
use super::targets::{
    ...
    install_omp, install_opencode, install_pi, install_qodercli, uninstall_antigravity_cli,
    uninstall_claude, uninstall_codex, uninstall_copilot, uninstall_cursor, uninstall_devin,

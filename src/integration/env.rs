...
pub(crate) const CODEWHALE_CONFIG_DIR_ENV_VAR: &str = "CODEWHALE_CONFIG_DIR";
...
pub(crate) fn codewhale_dir() -> io::Result<PathBuf> {
    config_dir_from_env_or_home(CODEWHALE_CONFIG_DIR_ENV_VAR, &[".codewhale"])
}

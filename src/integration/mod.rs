...
const VEYYON_EXTENSION_INSTALL_NAME: &str = "herdr-veyyon-agent-state.ts";
const VEYYON_EXTENSION_ASSET: &str = include_str!("assets/veyyon/herdr-agent-state.ts");
const VEYYON_INTEGRATION_VERSION: u32 = 1;
